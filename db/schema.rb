...
=======
ActiveRecord::Schema.define(version: 20_240_416_130_053) do
...
>>>>>>> 10d6e576558349b632541bc86edada181c9d5ade
  ...
  create_table 'collaborations', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[general_info_id collaborator_id],
            name: 'index_collaborations_on_general_info_id_and_collaborator_id', unique: true
  end
