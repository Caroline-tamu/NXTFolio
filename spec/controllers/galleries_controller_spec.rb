...
RSpec.describe GalleriesController, type: :controller do
  ...
  describe 'POST #create' do
    it 'should create a new gallery' do
      ...
      post :create,
           params: { gallery: { GeneralInfo_id: 1, gallery_title: 'test', gallery_description: 'test',
                                gallery_picture: [fixture_file_upload('background-creative.jpg', 'image/jpg')] } }
    ...
    it 'should not create a new gallery when there are too many pictures' do
      ...
      post :create,
           params: { gallery: { GeneralInfo_id: 1, gallery_title: 'test', gallery_description: 'test',
                                gallery_picture: [fixture_file_upload('1.jpg', 'image/jpg'), fixture_file_upload('2.jpg', 'image/jpg'), fixture_file_upload('3.jpg', 'image/jpg'), fixture_file_upload('4.jpg', 'image/jpg'), fixture_file_upload('5.jpg', 'image/jpg'), fixture_file_upload('6.jpg', 'image/jpg')] } }
      expect(response).to render_template :new
    end
    ...
    it 'should not create a new gallery' do
      ...
      GeneralInfo.create(first_name: 'R', last_name: 'Spec', highlights: 'test highlights',
                         company: 'test company', industry: 'test industry', emailaddr: 'testgmail.com', phone: 892, month_ofbirth: 0o1, day_ofbirth: 31, year_ofbirth: 1985, gender: 'Female', country: 'United States', state: 'TX', city: 'Denver', userKey: session[:current_user_key])
      post :create,
           params: { gallery: { GeneralInfo_id: 1, gallery_title: 'test',
  ...
  describe 'GET #delete' do
    it 'should delete a gallery image' do
      gallery = Gallery.create(GeneralInfo_id: 1, gallery_title: 'test', gallery_description: 'test',
                               gallery_picture: [fixture_file_upload('1.jpg', 'image/jpg'), fixture_file_upload('2.jpg', 'image/jpg'), fixture_file_upload('3.jpg', 'image/jpg'), fixture_file_upload('4.jpg', 'image/jpg'), fixture_file_upload('5.jpg', 'image/jpg')])
  ...
  describe 'GET #transfer' do
    it 'should add images to the gallery' do
      gallery = Gallery.create(GeneralInfo_id: 1, gallery_title: 'test', gallery_description: 'test',
                               gallery_picture: [fixture_file_upload('1.jpg', 'image/jpg'), fixture_file_upload('2.jpg', 'image/jpg'), fixture_file_upload('3.jpg', 'image/jpg')], test_picture: [fixture_file_upload('4.jpg', 'image/jpg'), fixture_file_upload('5.jpg', 'image/jpg')])
  ...
  describe 'GET #show' do
    it 'should show the gallery' do
      ...
      gallery = Gallery.create(GeneralInfo_id: general_info.id, gallery_title: 'test', gallery_description: 'test',
                               gallery_picture: [fixture_file_upload('1.jpg', 'image/jpg'), fixture_file_upload('2.jpg', 'image/jpg'), fixture_file_upload('3.jpg', 'image/jpg')])
      Collaboration.create(general_info_id: general_info.id)
